...
public interface JochreDocument extends Entity {
	...
	/**
	 * Is this document's locale left-to-right or right-to-left
	...
	/**
	 * Returns an xml representation of this document as it currently stands,
	 * to be used for correcting the text associated with this document.
	 * @return
	 */
	public void getXml(OutputStream outputStream);
	
	/**
	 * For a document containing pages which contain raw images,
	 * segments these images by converting them to JochreImages.
	 */
	public void segment();
	
	/**
	 * Segment the document and output the segmentation into
	...
	/**
	 * All images in this document, ordered by page index & image index.
	 * @return
	 */
	...
	/**
	 * Delete an image from this document.
	 * If it is the last image on the page, delete the page containing the image as well.
	 * @param image
	 */
