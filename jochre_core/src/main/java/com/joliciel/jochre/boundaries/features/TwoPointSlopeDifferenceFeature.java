...
/**
 * Like {@link SlopeDifferenceFeature}, except that we only look at the contour
 * point most distant from the start point.
 * 
 * @author Assaf Urieli
 *
 */
public class TwoPointSlopeDifferenceFeature extends AbstractSplitFeature<Double> implements DoubleFeature<Split> {
	private static final Logger LOG = LoggerFactory.getLogger(TwoPointSlopeDifferenceFeature.class);
