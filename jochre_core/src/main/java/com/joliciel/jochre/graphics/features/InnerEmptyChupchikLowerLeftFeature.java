...
import com.joliciel.jochre.graphics.ImageMirror;
...
/**
 * If we view the empty space at the centre of the shape, does it's lower-left
 * extremety narrow down to a thin chupchik (whether or not it's closed or
 * open). Useful for distinguishing Yiddish Mem from Tes, Shlos mem and Samekh.
 * 
 * @author Assaf Urieli
 *
 */
