 ...
 * </pre>
 * <p>
 * The idea is to get rid of noise on printed text pages, by maximising the contrast
 * after having brightened the image.
 */
...
public class BrightnessContrastOp implements BufferedImageOp, RasterOp {
     ...
     *        <code>null</code>
     */
    public BrightnessContrastOp (float[] scaleFactors, float[] offsets,
                      RenderingHints hints) {
