...
/**
 * Gives the relative bottom of the shape, where 0 is meanline - (baseline-meanline)
 * and 1 is baseline + (baseline - meanline).
 * @author Assaf Urieli
 *
 */
public final class RelativeBottomFeature extends AbstractShapeFeature<Double> implements DoubleFeature<ShapeWrapper> {
  @Override
