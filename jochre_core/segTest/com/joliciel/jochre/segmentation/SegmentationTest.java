...
/**
 * In these rather resource-heavy tests, we analyse real images, and ensure that the textual paragraphs have been
 * found in the correct order, with the correct area (more or less), and with the correct number of rows and number
 * of words on certain sample rows.
 * @author Assaf Urieli
 *
 */
public class SegmentationTest {
	...
	public void testMotlPessiDemKhazns(@Mocked JochrePage jochrePage) throws Exception {
		...
		jochreSession.setLocale(new Locale("yi"));
